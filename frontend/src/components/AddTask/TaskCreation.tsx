        ...
        <Modal.Body>
            <Form onSubmit={handleSubmit(onSubmit)}>
                <Form.Group className="group">
                    ...
                    <Form.Control className="control" type="text" {...register('taskName', {required: true})} placeholder="task name..."/>
                </Form.Group>
                <Form.Group className="group">
                <Form.Label className="label"> Task Description: </Form.Label>
                    <Form.Control className="control" type="text" {...register('taskDescription', {required: true})} placeholder="task description..."/>
                </Form.Group>
            </Form>
        </Modal.Body>
        <Modal.Footer>
