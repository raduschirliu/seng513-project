...
export default function Example() {
  ...
  let com2: IComment = {
    ...
    authorId: ass2._id,
    message:
      'I agree. This is the best task. The reason that this task is so good is because the instructions are so clear and they gave us so much time!',
  };
  ...
  let com5: IComment = {
    ...
    authorId: ass2._id,
    message:
      'Lorem ipsum dolousernamer sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat',
  };
  ...
  const taski: ITask = {
    ...
    status: 'inprogress',
    description:
      'This is the task. This task is very important. Please do the task quickly but also do it well. You have 1 day to complete this task. If you do not complete this task, you will be fired',
